...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-header">
                                Thêm mới bài viết <span class="" style="color: red">${mess}</span>
                            </div>
                            <div>   
                                <spring:form action="${pageContext.request.contextPath}/Admin/insertNew.htm" method="post" modelAttribute="new" enctype="multipart/form-data">
                                    <table id="product" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Loại bài viết</td>
                                                <td>
                                                    <spring:select path="typeId.typeNewId">

                                                        <spring:options items="${listTypeNews}" itemLabel="typeNewName" itemValue="typeNewId"/>                                                       
                                                    </spring:select>
                                            ...
                                            <tr>
                                                <td>Nội dung</td>
                                                <td>
                                                    <spring:textarea id="description" path="content"/>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>Hình ảnh </td>
                                                <td>
                                                    <spring:input type="file" path="newImage"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Status</td>
                                ...
                                <div>
                                    <a  href="${pageContext.request.contextPath}/Admin/listNews.htm" value="">Về trang danh sách</a>
                                </div>
                            </div>
                            <!-- /.col -->
                        </div>
        ...
        <script type="text/javascript">
            ...
            CKFinder.setupCKEditor(content, 'Admin/ckfinder/');
