                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div>   
                                <spring:form action="${pageContext.request.contextPath}/Admin/insertTrademark.htm" method="post" modelAttribute="trademark">
                                    <table id="subProductType" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <spring:input type="text" path="trademark"/>
                                                </td>
                                            </tr>
                                ...
                                <div>
                                    <a  href="${pageContext.request.contextPath}/Admin/listTrademark.htm" value="">Về trang danh sách</a>
                                </div>
                            </div>
                            <!-- /.col -->
                        </div>
