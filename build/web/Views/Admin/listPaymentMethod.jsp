            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">PaymentMethod</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div><a class="btn btn-primary" href="${pageContext.request.contextPath}/Admin/addPaymentMethod.htm">Thêm mới</a></div>
                            <div>
                            ...
                            <div> 
                                <table id="product" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${listPaymentMethod}" var="trademark" >
                                            <tr>


                                                <td>${trademark.paymentMethodId}  </td>
                                                <td>${trademark.paymentMethodName}  </td>

                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                        <a class="blue" href="detailPaymentMethod.htm?Id=${trademark.paymentMethodId}">
                                                            <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                        </a>
                                                        &#160;&#160;&#160;&#160;&#160;&#160;&#160;
                                                        <a class="green" href="updatePaymentMethod.htm?Id=${trademark.paymentMethodId}">
