                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-header">
                                Cập nhật sản phẩm <span class="" style="color: red">${mess}</span>
                            </div>
                            <div>   
                                <spring:form action="${pageContext.request.contextPath}/Admin/updatesProducts.htm" method="post" modelAttribute="product" enctype="multipart/form-data">
                                    <table id="product" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Id</td>
                                                <td>
                                                    <spring:input readonly="" type="text" path="productId"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Tên sản phẩm</td>
