                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div>   
                                <spring:form action="${pageContext.request.contextPath}/Admin/insertTypeProduct.htm" method="post" modelAttribute="typeProduct" >
                                    <table id="subProductType" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Loại sản phẩm</td>
                                                <td>
                                                    <spring:input type="text" path="typeName" />
                                                </td>
                                            </tr>
                                ...
                                <div>
                                    <a  href="${pageContext.request.contextPath}/Admin/listTypeProduct.htm" value="">Về trang danh sách</a>
                                </div>
                            </div>
                            <!-- /.col -->
                        </div>
