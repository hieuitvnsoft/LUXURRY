...
<html>
                ...
                <div class="col-md-9 header-left">
                    <div class="top-nav">
                        <ul class="memenu skyblue"><li class="active"><a href="${pageContext.request.contextPath}/home.htm">Trang chủ</a></li>
                                ...
                                <div class="mepanel">
                                    <div class="row">
                                        <div class="col1 me-one">
                                            ...
                                            <ul>
                                                <e:forEach items="${listTrademark}" var="trademark">
                            ...
                            <e:forEach items="${listType}" var="types">
    ...
    <div class="ckeckout">
        <div class="container">
            ...
            <div style="color: #c7254e">Trước khi thanh toán nên đăng ký đăng nhập để được chăm sóc tốt hơn.</div>
            <div class="ckeckout-top">
                <div class="cart-items">
                    <div class="row">
                        <spring:form action="${pageContext.request.contextPath}/order.htm" method="post" modelAttribute="order" enctype="multipart/form-data">
                            <div class="col-md-6">

                                <div class="form-group">
                                    <label class="form-label-group">Họ và tên</label>
                                    <spring:input type="text" name="fullName" path="fullName"  class="form-control" required="true" value="${loginUser.fullName}" placeholder="Nhập tên của bạn"/>
                                </div>
                                <div class="form-group">
                                    <label class="form-label-group">Địa chỉ nhận hàng</label>
                                    <spring:input type="text" name="addressShip" path="addressShip" class="form-control" required="true" value="${loginUser.address}" placeholder="Địa chỉ nhận hàng"/>
                                </div>
                                <div class="form-group">
                                    <label class="form-label-group">Số điện thoại</label>
                                    <spring:input type="text" path="phone" name="phone" class="form-control" required="true" value="${loginUser.phone}" placeholder="Nhập số điện thoại"/>
                                </div>
                                <div class="form-group">
                                    <label class="form-label-group">Chú thích đơn hàng</label>
                                    <spring:textarea cssClass="form-control"  path="description" name="description" class="form-control" type="text"  value="" placeholder="Note"/>
                                </div>
                                <div class="form-group">
                                    <label class="form-label-group">Hình thức thanh toán</label>
                                    <spring:select cssClass="form-control" path="paymentMethod.paymentMethodId">

                                        <spring:options items="${listPaymenMethod}" itemLabel="paymentMethodName" itemValue="paymentMethodId"/>                                                       
                                    </spring:select>
                                </div>
                                <div class="form-group">
                                    <label class="form-label-group">Hình thức vận chuyển</label>
                                    <spring:select cssClass="form-control" path="shipMethod.shipMethodId">

                                        <spring:options cssClass="form-control"  items="${listShipMethod}" itemLabel="shipMethodName" itemValue="shipMethodId"/>                                                       
                                    </spring:select>
                                </div>
                            ...
                            <div class="col-md-6">
                                <table class="table-bordered table">
                                    ...
                                    <tbody>
                                        ...
                                        <e:forEach items="${listCart}" var="ct" varStatus="loop">
                                            <tr>
                                                <td>${loop.index + 1}</td>
                                                <td>${ct.productName}</td>
                                                <td style="text-align: center" class="centered"><img src="/${ct.imageProduct}" style="width: 70px;" /></td>
                                                <td>
                                                    ${ct.quantity}
                                                </td>
                                                <td>
                                        ...
                                        <tr> <td colspan="3" style="text-align: right; color: #2980B9">TỔNG TIỀN THANH TOÁN:</td>
                                            <td colspan="2" style="text-align: right"><fmt:formatNumber currencyCode="vi_VN" value = " ${totalAmount}" /> vnđ</td>
                                        </tr>
                                    </tbody>
                            ...
                            <a class="btn btn-primary" href="${pageContext.request.contextPath}/checkout.htm">Quay lại check đơn hàng</a>
