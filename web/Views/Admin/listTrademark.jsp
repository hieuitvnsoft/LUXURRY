                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div><a class="btn btn-primary" href="${pageContext.request.contextPath}/Admin/addTrademark.htm">Thêm mới</a></div>
                            <div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                        <a class="blue" href="detailTrademark.htm?Id=${trademark.trademarkId}">
                                                            <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                        </a>
                                                        &#160;&#160;&#160;&#160;&#160;&#160;&#160;
                                                        <a class="green" href="updateTrademark.htm?Id=${trademark.trademarkId}">
