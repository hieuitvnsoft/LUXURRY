                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div><a class="btn btn-primary" href="${pageContext.request.contextPath}/Admin/addTypeProduct.htm">Thêm mới</a></div>
                            <div>
                            ...
                            <div> 
                                <table id="product" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${listTypeProduct}" var="t"  >
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                        <a class="blue" href="detailTypeProduct.htm?Id=${t.id}">
                                                            <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                        </a>
                                                        &#160;&#160;&#160;&#160;&#160;&#160;&#160;
                                                        <a class="green" href="updateTypeProduct.htm?Id=${t.id}">
