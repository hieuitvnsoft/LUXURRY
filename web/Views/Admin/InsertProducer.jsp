                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div>   
                                <form action="${pageContext.request.contextPath}/Admin/insertProducer.htm" method="post" modelAttribute="producer">
                                ...
                                <div>
                                    <a  href="${pageContext.request.contextPath}/Admin/listProducer.htm" value="">Về trang danh sách</a>
                                </div>
                            </div>
                            <!-- /.col -->
                        </div>
