                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div><a class="btn btn-primary" href="${pageContext.request.contextPath}/Admin/addNewShipMethod.htm">Thêm mới</a></div>
                            <div>
                            ...
                            <div> 
                                <table id="product" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${listShipMethod}" var="ship" >
                                            <tr>


                                                <td>${ship.shipMethodId}  </td>
                                                <td>${ship.shipMethodName}  </td>

                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                        <a class="blue" href="detailTrademark.htm?Id=${ship.shipMethodId}">
                                                            <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                        </a>
                                                        &#160;&#160;&#160;&#160;&#160;&#160;&#160;
                                                        <a class="green" href="updateTrademark.htm?Id=${ship.shipMethodId}">
