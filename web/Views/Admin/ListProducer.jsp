                                        ...
                                        <div>    
                                            <table id="product" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                        ...
                                                        <c:forEach items="${listProducer}" var="listProducer">
                                                    <tr>


                                                        <td>${listProducer.producerId}  </td>
                                                       <td>
                                                        <td>${listProducer.producerName}</td>
                                                    
                                                        
                                                        
                                                       
                                                          <c:if test="${listProducer.status == 'True'}">
                                                         <td>
                                                            Kích hoạt
                                                        </td>
                                                    </c:if>
                                                    <c:if test="${listProducer.status == 'False'}">
                                                         <td>
                                                            Không kích hoạt
                                                        </td>
                                                    </c:if>
                                                        ...
                                                        <td>
                                                            <div class="hidden-sm hidden-xs action-buttons">
                                                                <a class="blue" href="viewProduct.htm?Id=${product.producerId}">
                                                                    <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                                </a>

                                                                <a class="green" href="initUpdateProduct.htm?Id=${product.producerId}">
                                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                                </a>

                                                                <a class="red" href="deleteProduct.htm?Id=${product.producerId}">
