...
<%@ taglib prefix="tag" uri="/WEB-INF/tlds/customTaglib" %>
...
<html>
    ...
    <div class="bnr" id="home">
        <div  id="top" class="callbacks_container">
            <ul class="rslides" id="slider4">
                <li>
                    <img src="/LUXURY/Views/Fontend/images/bnr-1.jpg" alt=""/>
                </li>
                <li>
                    <img src="/LUXURY/Views/Fontend/images/bnr-2.jpg" alt=""/>
                </li>
                <li>
                    <img src="/LUXURY/Views/Fontend/images/bnr-3.jpg" alt=""/>
                </li>
            </ul>
        </div>
        <div class="clearfix"> </div>
    ...
    <!--banner-ends--> 
    <!--Slider-Starts-Here-->
    <script src="/LUXURY/Views/Fontend/js/responsiveslides.min.js"></script>
            ...
            <div class="about-top grid-1">
                <div class="col-md-4 about-left">
                    <figure class="effect-bubba">
                        <img class="img-responsive" src="/LUXURY/Views/Fontend/images/abt-1.jpg" alt=""/>
                        <figcaption>
                            <h2>Quý phái, sang trọng</h2>
                            <p>Đẳng cấp của doanh nhân</p>	
                        </figcaption>			
                    </figure>
                </div>
                <div class="col-md-4 about-left">
                    <figure class="effect-bubba">
                        <img class="img-responsive" src="/LUXURY/Views/Fontend/images/abt-2.jpg" alt=""/>
                        <figcaption>
                            <h4>Mạnh mẽ</h4>
                            <p>Mạnh mẽ, bền bỉ với thời gian</p>	
                        </figcaption>			
                    </figure>
                </div>
                <div class="col-md-4 about-left">
                    <figure class="effect-bubba">
                        <img class="img-responsive" src="/LUXURY/Views/Fontend/images/abt-3.jpg" alt=""/>
                        <figcaption>
                            <h4>Phong cách</h4>
                            <p>Phong cách chất chơi người dơi</p>	
                        </figcaption>			
                    </figure>
                </div>
                <div class="clearfix"></div>
    ...
    <div class="product"> 
        <div class="container">
            <div class="product-top">
                <h3>Danh sách sản phẩm tìm kiếm được</h3>
            ...
            <%--<tag:paginate max="10" offset="${offset}" count="${count}" uri="${pageContext.request.contextPath}/home.htm" next="&raquo;" previous="&laquo;"/>--%>
        </div>
    </div>
    <!--product-end-->
    <!--information-starts-->
